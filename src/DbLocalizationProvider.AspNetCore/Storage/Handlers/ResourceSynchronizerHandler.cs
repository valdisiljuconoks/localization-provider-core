...
namespace DbLocalizationProvider.AspNetCore.Storage.Handlers
{
    public class ResourceSynchronizerHandler : IQueryHandler<SyncResources.Query, IEnumerable<LocalizationResource>>
    {
        ...
        private void RegisterDiscoveredResources(ICollection<DiscoveredResource> properties,
        ...
        private static void AddTranslationScript(LocalizationResource existingResource, StringBuilder buffer,
